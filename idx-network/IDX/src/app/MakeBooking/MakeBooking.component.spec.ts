...
describe('MakeBookingComponent', () => {
  ...
  let mockMakeBookingService;
  let mockDataService

  beforeEach(async(() => {

    mockMakeBookingService = sinon.createStubInstance(MakeBookingService);
    mockMakeBookingService.getAll.returns([]);
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        {provide: MakeBookingService, useValue: mockMakeBookingService },
